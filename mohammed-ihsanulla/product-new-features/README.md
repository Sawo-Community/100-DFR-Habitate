...
- Using flash card, we can improve community engagement in fun style
- While Creatng a post or existing post make some questions from them add points.
- and then show the flash card when user revisit a post and store points for feature use like offer free webinars, pre-release product usage,discount on product subcription like ect..,

### 2. Community analytics

<img src="../assets/images/community_analytics.jpg" alt="Habitate"></a>
